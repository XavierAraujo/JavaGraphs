...
class DirectedAdjacentListGraphTest {
    ...
    void basicTopologyTest() throws VertexNotFoundException {
        ...
        assertFalse(graph.isNeighbor(v3, v0));
        ...
        assertFalse(graph.isNeighbor(v5, v0));
        assertFalse(graph.isNeighbor(v5, v1));
        ...
        assertFalse(graph.isNeighbor(v6, v0));
        assertFalse(graph.isNeighbor(v6, v1));
        ...
        assertFalse(graph.isNeighbor(v7, v3));
        assertFalse(graph.isNeighbor(v7, v4));
        assertFalse(graph.isNeighbor(v7, v5));
        ...
        assertFalse(graph.isNeighbor(v8, v2));
        assertFalse(graph.isNeighbor(v8, v3));
        ...
        assertFalse(graph.isNeighbor(v9, v0));
