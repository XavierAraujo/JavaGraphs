...
class UndirectedAdjacentListGraphTest {
    ...
    void basicTopologyTest() throws VertexNotFoundException {
        ...
        assertTrue(graph.areVerticesNeighbors(v3, v0));
        ...
        assertTrue(graph.areVerticesNeighbors(v5, v0));
        assertTrue(graph.areVerticesNeighbors(v5, v1));
        ...
        assertTrue(graph.areVerticesNeighbors(v6, v0));
        assertTrue(graph.areVerticesNeighbors(v6, v1));
        ...
        assertTrue(graph.areVerticesNeighbors(v7, v3));
        assertFalse(graph.areVerticesNeighbors(v7, v4));
        assertTrue(graph.areVerticesNeighbors(v7, v5));
        ...
        assertTrue(graph.areVerticesNeighbors(v8, v2));
        assertTrue(graph.areVerticesNeighbors(v8, v3));
        ...
        assertTrue(graph.areVerticesNeighbors(v9, v0));
